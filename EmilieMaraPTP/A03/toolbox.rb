...
require_relative 'toolbox/tk_methoden_dialog'

# Author:: Birgit Wendholt, von der BlueJ Version von Michael Kölling und David J. Barnes nach Ruby portiert. 
...
class Toolbox 
  ...
  def add_menu_leiste() 
    ...
    def get_instanzen_menu(klasse)
      ...
      if !@instanzen_menus.has_key?(klasse)
